...
set(JUCE_MODULES_DIR "${PACKAGE_PREFIX_DIR}/include/JUCE-6.0.0/modules" CACHE INTERNAL
    "The path to JUCE modules")

include("${PACKAGE_PREFIX_DIR}/lib/cmake/JUCE-6.0.0/JUCEUtils.cmake")
...
foreach(_juce_module IN LISTS _juce_modules)
    juce_add_module("${PACKAGE_PREFIX_DIR}/include/JUCE-6.0.0/modules/${_juce_module}" ALIAS_NAMESPACE juce)
endforeach()
